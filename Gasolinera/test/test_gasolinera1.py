...
def test_inicial(gasolinera1_contract,accounts):
    ...
    assert gasolinera1_contract.seleccion(1) == SEL1
    assert gasolinera1_contract.seleccion(2) == SEL2
    assert gasolinera1_contract.seleccion(3) == SEL3
    assert gasolinera1_contract.seleccion(4) == SEL4
    assert gasolinera1_contract.seleccion(5) == SEL5
    assert gasolinera1_contract.seleccion(6) == SEL6
    assert gasolinera1_contract.seleccion(7) == SEL7
    
    

def test_comprovacion(gasolinera1_contract,accounts):
    ...
    gasolinera1_contract.echargasolina(1,"G95",1,{'from':accounts[1],'value':10})
...
def test_failed_transactions(gasolinera1_contract, accounts):
    with brownie.reverts("Bien escrito"):
        gasolinera1_contract.echargasolina(1,"G58",1,{'from':accounts[1],'value':10})
    ...
    with brownie.reverts("Precio valido"):
        gasolinera1_contract.echargasolina(1,"G98",1,{'from':accounts[1],'value':18})
       
    with brownie.reverts("Hay litros suficientes"):
        gasolinera1_contract.echargasolina(1,"G98",7,{'from':accounts[1],'value':100})
    ...
    gasolinera1_contract.echargasolina(1,"G95",2,{'from':accounts[1],'value':20})
