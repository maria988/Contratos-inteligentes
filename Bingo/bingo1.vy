...
def linea(n1: uint256, n2: uint256,n3: uint256,n4: uint256,n5: uint256):
    ...
    assert ((n1 != n2) and (n1!= n3) and (n1 != n4) and(n1 != n5) and (n2 != n3) and (n2 != n3) and ( n3 != n4) and (n3 != n5) and (n3 != n4) and (n3 != n5) and (n4 != n5)),"Todos distintos"
    self.yalinea =True
    send(msg.sender, (self.acumulado * self.porc_linea)/100)
